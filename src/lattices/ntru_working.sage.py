...
# This file was *autogenerated* from the file src/lattices/ntru_working.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1p17 = RealNumber('1.17'); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_100 = Integer(100); _sage_const_0 = Integer(0); _sage_const_40 = Integer(40); _sage_const_8 = Integer(8); _sage_const_16 = Integer(16); _sage_const_32 = Integer(32); _sage_const_257 = Integer(257)
...
class NTRULattice:
    ...
    def generate_keys(self, max_attempts=_sage_const_100 ):
        ...
        for attempt in range(max_attempts):
            ...
            for i in range(self.n):
                ...
                f_coeffs.append(choice([-_sage_const_1 , _sage_const_0 , _sage_const_1 ]))
                g_coeffs.append(choice([-_sage_const_1 , _sage_const_0 , _sage_const_1 ]))
    ...
    def _make_simple_basis(self):
        ...
        for i in range(self.n):
            for j in range(self.n):
                idx = (j - i) % self.n
                H[i,j] = h_coeffs[idx] if idx < len(h_coeffs) else _sage_const_0 
    ...
    def gram_schmidt_norms(self):
        ...
        # Simple GS
        for i in range(min(B.nrows(), _sage_const_2 *self.n)):
            v = vector(B[i])
            for j in range(i):
                if j < len(norms) and norms[j] > _sage_const_0 :
                    v = v - (v.dot_product(B[j]) / (B[j].norm()**_sage_const_2 )) * B[j]
...
for n in [_sage_const_8 , _sage_const_16 , _sage_const_32 ]:
    print(f"\nTesting n={n}, q=257")
    
    ntru = NTRULattice(n, _sage_const_257 )
    ...
    if ntru.generate_keys():
        ...
        if gs and len(gs) >= _sage_const_2 :
            print(f"First GS norms: {gs[_sage_const_0 ]:.2f}, {gs[_sage_const_1 ]:.2f}")
    else:
