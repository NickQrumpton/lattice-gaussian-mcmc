...
# This file was *autogenerated* from the file src/lattices/ntru_fixed.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1p17 = RealNumber('1.17'); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_100 = Integer(100); _sage_const_2 = Integer(2); _sage_const_40 = Integer(40); _sage_const_16 = Integer(16); _sage_const_257 = Integer(257); _sage_const_20 = Integer(20)
...
class NTRULattice:
    ...
    def _conjugate(self, f):
        ...
        conj = [coeffs[_sage_const_0 ]]
        for i in range(_sage_const_1 , self.n):
    ...
    def _solve_ntru(self, f, g):
        ...
        # Get constant terms
        nf = ZZ(self._get_coeffs(Nf, self.n)[_sage_const_0 ])
        ng = ZZ(self._get_coeffs(Ng, self.n)[_sage_const_0 ])
    ...
    def generate_keys(self, max_attempts=_sage_const_100 ):
        ...
        for attempt in range(max_attempts):
            ...
            try:
                ...
                if abs(check_coeffs[_sage_const_0 ]) == self.q and all(c == _sage_const_0  for c in check_coeffs[_sage_const_1 :]):
                    # Generate basis
                    self._make_basis()
                    return True
    ...
    def gram_schmidt_norms(self):
        ...
        for i in range(B.nrows()):
            ...
            for j in range(len(gs_vecs)):
                if gs_norms[j] > _sage_const_0 :
                    proj_coeff = v.dot_product(gs_vecs[j]) / (gs_norms[j]**_sage_const_2 )
...
if __name__ == "__main__":
    ...
    n, q = _sage_const_16 , _sage_const_257 
    print(f"\nParameters: n={n}, q={q}")
    ...
    print("\nGenerating keys...")
    success = ntru.generate_keys(max_attempts=_sage_const_20 )
    ...
    if success:
        ...
        # Show key norms
        f_norm = sqrt(sum(c**_sage_const_2  for c in ntru._get_coeffs(ntru.f, n)))
        g_norm = sqrt(sum(c**_sage_const_2  for c in ntru._get_coeffs(ntru.g, n)))
        print(f"\nKey norms:")
        print(f"||f|| = {f_norm:.2f}")
        print(f"||g|| = {g_norm:.2f}")
