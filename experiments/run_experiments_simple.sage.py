...
# This file was *autogenerated* from the file run_experiments_simple.sage
from sage.all_cmdline import *   # import sage library

_sage_const_60 = Integer(60); _sage_const_16 = Integer(16); _sage_const_64 = Integer(64); _sage_const_256 = Integer(256); _sage_const_0p5 = RealNumber('0.5'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_2p0 = RealNumber('2.0'); _sage_const_10000 = Integer(10000); _sage_const_100000 = Integer(100000); _sage_const_0 = Integer(0); _sage_const_1000 = Integer(1000); _sage_const_1 = Integer(1); _sage_const_50 = Integer(50); _sage_const_0p0 = RealNumber('0.0'); _sage_const_10 = Integer(10); _sage_const_2 = Integer(2); _sage_const_257 = Integer(257); _sage_const_12289 = Integer(12289); _sage_const_10p0 = RealNumber('10.0'); _sage_const_50p0 = RealNumber('50.0'); _sage_const_100p0 = RealNumber('100.0'); _sage_const_100 = Integer(100); _sage_const_1en10 = RealNumber('1e-10'); _sage_const_500 = Integer(500); _sage_const_5000 = Integer(5000); _sage_const_30 = Integer(30); _sage_const_80 = Integer(80); _sage_const_42 = Integer(42)
import sys
import os
...
def run_identity_lattice_experiments():
    ...
    # Test dimensions
    dimensions = [_sage_const_16 , _sage_const_64 , _sage_const_256 ]
    
    # Sigma regimes (relative to sqrt(n))
    sigma_factors = {
        'hard': _sage_const_0p5 ,
        'near': _sage_const_1p0 ,
        'smooth': _sage_const_2p0 
    }
    ...
    for n in dimensions:
        ...
        for regime, factor in sigma_factors.items():
            sigma = factor * sqrt(n)
            n_samples = min(_sage_const_10000 , _sage_const_100000  // n)  # Adjust for dimension
            ...
            for i in range(n_samples):
                ...
                if i > _sage_const_0  and i % _sage_const_1000  == _sage_const_0 :
            ...
            acf = compute_autocorrelation(first_coord, max_lag=_sage_const_50 )
            ...
            result = {
                ...
                'acf_lag_1': float(acf[_sage_const_1 ]) if len(acf) > _sage_const_1  else _sage_const_0p0 ,
                'acf_lag_10': float(acf[_sage_const_10 ]) if len(acf) > _sage_const_10  else _sage_const_0p0 
            }
...
def run_ntru_lattice_experiments():
    ...
    # NTRU parameters
    ntru_configs = [
        {'n': _sage_const_64 , 'q': _sage_const_257 },
        {'n': _sage_const_64 , 'q': _sage_const_12289 },
        # {'n': 512, 'q': 12289}  # Uncomment for full run
    ]
    
    sigma_factors = {
        'hard': _sage_const_10p0 ,
        'medium': _sage_const_50p0 ,
        'smooth': _sage_const_100p0 
    }
    ...
    for config in ntru_configs:
        ...
        for regime, sigma in sigma_factors.items():
            n_samples = _sage_const_1000   # Smaller for NTRU due to cost
            ...
            B = ntru.get_basis()
            in_lattice = _sage_const_0 
            
            for i in range(n_check):
                try:
                    coeffs = B.solve_left(vector(samples[i]))
                    if all(abs(c - round(c)) < _sage_const_1en10  for c in coeffs):
                        in_lattice += _sage_const_1 
                except:
                    pass
            ...
            print(f"    Rate = {result['samples_per_sec']:.1f} samples/sec")
            print(f"    Lattice membership = {result['lattice_membership_rate']*_sage_const_100 :.0f}%")
...
def run_convergence_experiments():
    ...
    for n_iter in iterations:
        ...
        samples_array = np.array([[float(x) for x in v] for v in samples])
        sample_norms = np.linalg.norm(samples_array, axis=_sage_const_1 )
    ...
    with open('results/diagnostics/convergence_data.json', 'w') as f:
        json.dump(convergence_data, f, indent=_sage_const_2 )
